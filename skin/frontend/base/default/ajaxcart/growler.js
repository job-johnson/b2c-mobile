...
Growler = (function(){
	...
	return Class.create({
		...
		// syed ajax	return specialNotice(this.growler, msg, options, "Warning!", "#F6BD6F", "#000");
		}
		,error: function(msg, options){
			return specialNotice(this.growler, msg, options, "Critical!", "#F66F82", "#000");
		}
		,info: function(msg, options){
		document.getElementById("mini-cart-count").innerHTML = msg.slice(0,1);
		return specialNotice(this.growler, msg.slice(1), options, "Information!", "#BBF66F", "#000");
		}
