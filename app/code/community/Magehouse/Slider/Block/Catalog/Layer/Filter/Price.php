	...
	public function getHtml(){
		...
		if($this->getSliderStatus()){
			...
			$text='
				...
				</div>'.$this->getSliderJs().'<p class="range"><span>Range</span>
						<input type="text" id="amount" readonly="readonly" style="background:none; border:none;" value="'.Mage::helper('core')->currency($this->getCurrMinPrice(), true, false)." - ".Mage::helper('core')->currency($this->getCurrMaxPrice(), true, false).'" />
						</p>';
