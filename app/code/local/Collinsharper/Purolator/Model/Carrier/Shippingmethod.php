...
//            }
            ...
            if($prod['service'] == 'PurolatorGround'){
              $_customMethodTitle = 'Purolator Ground: Delivery in 3 to 5 Business Days';
            }elseif($prod['service'] == 'PurolatorExpress'){
                $_customMethodTitle = 'Purolator Express: Delivery in 2 to 3 Business Days';
              }else{
                $_customMethodTitle= $_method_title;
              }
              // custome code by purlator syed.
            $method = Mage::getModel('shipping/rate_result_method');
            $method->setCarrier($this->_code);
            $method->setCarrierTitle($this->getConfig('title'));
            $method->setMethod($prod['service']);
            $method->setMethodTitle($_customMethodTitle);
